...
import 'package:imt_calculator/screens/final_imt/final_imt_provider.dart';
import 'package:imt_calculator/screens/utils/app_routes.dart';

class IMTCal extends StatefulWidget {
  const IMTCal({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushNamed(context, AppRoutes.imtList); // Navigate to list screen
          },
        ),
      ),
      body: Padding(
